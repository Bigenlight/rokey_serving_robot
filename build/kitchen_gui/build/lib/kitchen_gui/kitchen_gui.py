...
from kitchen_gui.srv import OrderService
from kitchen_gui.msg import CallService
...
class KitchenGUI(QWidget):
    ...
    def perform_function(self, function):
        if self.selected_table:
            print(f"{self.selected_table}에서 {function} 기능을 수행합니다.")
        else:
            print("선택된 테이블이 없습니다.")
